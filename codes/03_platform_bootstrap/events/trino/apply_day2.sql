-- events day2 apply for trino

TRUNCATE TABLE memory.raw_events.events;

INSERT INTO memory.raw_events.events (event_id, user_id, event_at, event_name, platform, session_id) VALUES
