-- events day2 apply for bigquery

DELETE FROM `raw_events.events` WHERE TRUE;
...
('e5', 9001, TIMESTAMP '2026-04-03 07:10:00', 'purchase', 'web', 's4'),
('e6', 9002, TIMESTAMP '2026-04-03 11:20:00', 'page_view', 'ios', 's5');
